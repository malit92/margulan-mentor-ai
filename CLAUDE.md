...
Контент сайта НА СЕГОДНЯ построен на 10 идеях, переданных пользователем в первой сессии. Это **единственный канон** до появления реальных транскриптов Маргулана:

1. Если нет миссии, цели разрозненны.
2. Счастье состоит из здоровья, безопасности, свободы, любимых людей и любимого дела.
3. Энергия — главный ресурс.
4. Эффективность — результат, делённый на затраты.
5. Кайдзен-планирование — не список задач, а поток маленьких действий.
6. Осознанность — свобода выбора реакции.
7. Ошибки нужны для эволюции.
8. Деньги, связи, власть, репутация — формы энергии.
9. Лидерство — переход от власти к вдохновению и экосистеме.
10. Успех — это счастье, а не просто деньги или статус.

**Любые другие смысловые утверждения, которых нет в этом списке, — выдумка (нарушение правила 3).** Нужно расширять — нужны транскрипты в `C:\Users\ildmu\OneDrive\Desktop\New folder\` (см. CLAUDE.md соседнего RAG-проекта).
